  ...
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
      ...
      <div className="bg-[#121212] h-[15%] rounded flex flex-col justify-around">
        <div onClick={()=>nav("/")} className="flex pl-8 gap-3 items-center cursor-pointer">
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1">
          ...
          <button className="px-4 py-1.5 text-[15px] bg-white text-black rounded-full cursor-pointer mt-4">
            Create Playlist
          </button>
        </div>
